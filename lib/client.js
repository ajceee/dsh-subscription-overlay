...
`;
		const DOCK_STYLE_TAG_ID = "dsh-subscription-overlay/dock";
...
`;
		...
		*/
		...
		function dockFillClass(percent, alertPct) {
		...
		*/
		...
		function resetText$1(resetAt, t) {
		...
		function DockBadge(props) {
			...
			const [anchorTop, setAnchorTop] = (0, react.useState)(null);
			const [anchorLeft, setAnchorLeft] = (0, react.useState)(null);
			(0, react.useEffect)(() => {
				if (!open) return;
				const measure = () => {
			...
			(0, react.useEffect)(() => {
				...
				const onPointer = (event) => {
					...
					if (target !== null && panelRef.current !== null && !panelRef.current.contains(target) && anchorRef.current !== null && !anchorRef.current.contains(target)) setOpen(false);
				};
			...
			const label = okProviders.length > 0 ? okProviders.map((p) => dockCompactSegment(p)).join(" | ") : t("dock.unavailable");
			...
			const dialogLeft = Math.max(DIALOG_MARGIN, Math.min(anchorLeft ?? vw - dialogWidth - DIALOG_MARGIN, vw - dialogWidth - DIALOG_MARGIN));
			const dialogBottom = Math.max(DIALOG_MARGIN, vh - (anchorTop ?? vh - DIALOG_MARGIN) + DIALOG_GAP);
			const pill = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				ref: anchorRef,
				className: "dso-dock-anchor",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
					"data-dso-dock": "1",
					className: "dso-dock-pill",
					style: hover || open ? { background: "var(--dsw-alias-interactive-bg-hover)" } : void 0,
					...
					onClick: toggle,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `dso-dot ${dotClass$1(state)}` }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dso-dock-label",
							children: label
						}),
						alerts > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dso-alert",
			...
			if (!open) return pill;
			const dialog = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: panelRef,
				role: "dialog",
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							state.providers.map((p) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DockProviderCard, {
								provider: p,
								state,
								t
							}, p.id)),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [pill, typeof document === "undefined" ? dialog : (0, react_dom.createPortal)(dialog, document.body)] });
		}
		function DockProviderCard({ provider, state, t }) {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							className: `dso-badge ${badgeClass$1(provider.status)}`,
					...
					provider.status === "ok" && items.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dso-items",
						children: items.map((item, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DockUsageRow, {
							item,
		...
		function DockUsageRow({ item, alertPct, t }) {
			const percent = dockUsedPercent(item);
			const value = item.display ?? (percent !== void 0 ? `${percent}%` : item.remaining !== void 0 ? t("item.remaining", { n: item.remaining }) : "");
			const reset = resetText$1(item.resetAt, t);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dso-item",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: percent !== void 0 ? `${dockWindowLabel(item)} ${value}` : value
					}),
