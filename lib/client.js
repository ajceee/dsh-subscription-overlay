...
`;
		...
		*/
		function CommandcodeCard({ provider, t, onProbe, state }) {
			...
			const probeLine = probe === void 0 ? "" : probe.ok ? t(probe.models !== void 0 && probe.models.length > 0 ? "probe.ok" : "probe.okNoModels", {
				ms: probe.ms,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					provider.status === "ok" && (!Array.isArray(provider.items) || provider.items.length === 0) && probe === void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dso-provider-msg",
						children: t("panel.empty")
					}),
					probe !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: `dso-probe-line${!probe.ok ? " dso-probe-line--err" : ""}`,
						children: probeLine
					}), probe.ok && probe.models !== void 0 && probe.models.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dso-provider-msg",
