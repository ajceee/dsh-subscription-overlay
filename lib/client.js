	...
	factory: (require) => {
		...
		*/
		...
		function summarizeProvider(p) {
			...
			const head = (item) => {
				...
				const tag = /5\s*h/i.test(item.label) ? "5h" : /7\s*d/i.test(item.label) ? "7d" : /month/i.test(item.label) ? "月" : /primary/i.test(item.label) ? "主" : /secondary/i.test(item.label) ? "次" : "";
		...
		function translate(lang, key, params) {
			let text = (lang === "en" ? en : zh)[key] ?? zh[key] ?? key;
		...
		*/
		...
		function tx(lang, key, params) {
			const full = key.startsWith("settings.") ? key : `settings.${key}`;
			let text = (lang === "en" ? enExtra : zhExtra)[full] ?? zhExtra[full] ?? full;
			if (params) for (const [k, v] of Object.entries(params)) text = text.replaceAll(`{${k}}`, String(v));
			return text;
		}
		const DEFAULT_FORM = {
		...
		async function api(path, body) {
			...
			if (!response.ok) throw new Error(translate(browserLang(), "error.requestFailed", { status: response.status }));
			const data = await response.json();
			if (body !== void 0 && typeof data["statusMessage"] === "string") throw new Error(data["statusMessage"]);
			return data;
		}
		...
		function OverlaySettingsSection() {
			...
			if (loading) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: translate(lang, "panel.refreshing")
				})
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dso-section-hint",
						children: tx(lang, "settings.enabledHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dso-section-row",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: { flex: 1 },
							children: tx(lang, "settings.providers")
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dso-section-row",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: tx(lang, "settings.provider.claude")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: tx(lang, "settings.provider.codex")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: tx(lang, "settings.provider.opencodeGo")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: tx(lang, "settings.provider.commandcode")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: tx(lang, "settings.pollMinutes")
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dso-section-hint",
						children: tx(lang, "settings.pollHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dso-section-row",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							htmlFor: "dso-settings-alert",
							children: tx(lang, "settings.alertPct")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dso-section-hint",
						children: tx(lang, "settings.alertHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dso-section-row",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							htmlFor: "dso-settings-budget",
							children: tx(lang, "settings.budget")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dso-section-hint",
						children: tx(lang, "settings.budgetHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dso-section-row",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: { flex: 1 },
							children: tx(lang, "settings.hotkey")
					...
					saved && error === "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: tx(lang, "settings.saved")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dso-section-row",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							disabled: saving,
							onClick: save,
							children: saving ? tx(lang, "settings.saving") : tx(lang, "settings.save")
						})
					})
				]
			});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [state.open && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dso-foot",
							children: state.refreshedAt > 0 ? t("panel.footer.refreshedAt", { time: new Date(state.refreshedAt).toLocaleString(lang === "zh" ? "zh-CN" : "en-US") }) : t("panel.footer.never")
						})
					]
				}), floater]
			});
